...
import styles from '../../styles/components/templates/PartFiveDetailBody.module.scss';
...
const PartFiveDetailBody: NextPage<PropType> = (props) => {
	...
	return (
		<>
			<h2 className={styles.titleH2}>PART 5: INCOMPLETE SENTENCES</h2>
			...
			<div className="row">
				...
				<div className="col-xxl-8 col-12 col-md-12">
					<div className={styles.questionView}>
						<div className={styles.questionText}>Each spring, Westside Construction ________ several individuals for new positions at its various worksites.</div>
...
export default PartFiveDetailBody;