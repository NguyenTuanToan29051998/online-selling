...
import styles from '../../styles/components/templates/PartFourDetailBody.module.scss';
...
const PartFourDetailBody: NextPage<PropType> = (props) => {
	...
	return (
		<>
			<h2 className={styles.titleH2}>PART 4: SHORT TALKS</h2>
...
export default PartFourDetailBody;