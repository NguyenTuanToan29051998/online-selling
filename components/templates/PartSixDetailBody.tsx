...
import styles from '../../styles/components/templates/PartSixDetailBody.module.scss';
...
const PartSixDetailBody: NextPage<PropType> = (props) => {
	...
	return (
		<>
			<h2 className={styles.titleH2}>PART 6: TEXT COMPLETION</h2>
...
export default PartSixDetailBody;