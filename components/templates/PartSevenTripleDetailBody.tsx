...
import styles from '../../styles/components/templates/PartSevenDoubleDetailBody.module.scss';
...
const PartSevenDoubleDetailBody: NextPage<PropType> = (props) => {
	...
	return (
		<>
			<h2 className={styles.titleH2}>PART 7: TRIPLE PASSAGES</h2>
...
export default PartSevenDoubleDetailBody;