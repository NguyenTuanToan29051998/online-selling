...
import styles from '../../styles/components/templates/PartTwoDetailBody.module.scss';
...
const PartTwoDetailBody: NextPage<PropType> = (props) => {
	...
	return (
		<>
			<h2 className={styles.titleH2}>PART 2: QUESTION- RESPONSE</h2>
...
export default PartTwoDetailBody;