...
import PartFiveDetailBody from '../../../components/templates/PartFiveDetailBody';

const PartFiveDetail: NextPageWithLayout = (props: any) => {
	...
	return (
		<CustomContainer size="large">
			...
			<PartFiveDetailBody questionList={questionList} />
		</CustomContainer>
	);
};

PartFiveDetail.getLayout = function getLayout(page: ReactElement) {
	return (
		<Layout>
			{page}
		</Layout>
