...
import PartThreeDetailBody from '../../../components/templates/PartThreeDetailBody';

const PartThreeDetail: NextPageWithLayout = (props: any) => {
	...
	return (
		<CustomContainer size="large">
			...
			<PartThreeDetailBody questionList={questionList} />
		</CustomContainer>
	);
};

PartThreeDetail.getLayout = function getLayout(page: ReactElement) {
	return (
		<Layout>
			{page}
		</Layout>
