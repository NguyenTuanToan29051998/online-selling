...
import PartSevenDoubleDetailBody from '../../../components/templates/PartSevenDoubleDetailBody';

const PartSevenDoubleDetail: NextPageWithLayout = (props: any) => {
	...
	return (
		<CustomContainer size="large">
			...
			<PartSevenDoubleDetailBody questionList={questionList} />
		</CustomContainer>
	);
};

PartSevenDoubleDetail.getLayout = function getLayout(page: ReactElement) {
	return (
		<Layout>
			{page}
		</Layout>
...
export default PartSevenDoubleDetail;
