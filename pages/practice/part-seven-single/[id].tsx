...
import PartSevenSingleDetailBody from '../../../components/templates/PartSevenSingleDetailBody';

const PartSevenSingleDetail: NextPageWithLayout = (props: any) => {
	...
	return (
		<CustomContainer size="large">
			...
			<PartSevenSingleDetailBody questionList={questionList} />
		</CustomContainer>
	);
};

PartSevenSingleDetail.getLayout = function getLayout(page: ReactElement) {
	return (
		<Layout>
			{page}
		</Layout>
...
export default PartSevenSingleDetail;
