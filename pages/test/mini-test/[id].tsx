...
import MiniTestDetailBody from '../../../components/templates/MiniTestDetailBody';

const MiniTestDetail: NextPageWithLayout = (props: any) => {
	...
	return (
		<CustomContainer size="large">
			...
			<MiniTestDetailBody questionList={questionList} />
		</CustomContainer>
	);
};

MiniTestDetail.getLayout = function getLayout(page: ReactElement) {
	return (
		<Layout>
			{page}
		</Layout>
